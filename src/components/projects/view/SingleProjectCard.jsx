...
import { deleteProjectLoad } from '../../../redux/actions/project';
...
const SingleProjectCard = ({ project, page }) => {
  ...
  const content = (
    <>
      ...
      <ul>
        {['react', 'redux', 'java', 'scala', 'ruby', 'python', 'go'].map(
          (name) => (
            <Link>
              <li>{name}</li>
            </Link>
  ...
  return (
    <div className="ui card">
      <div className="content">
        <div
          className="header"
          style={{ textTransform: 'capitalize', color: 'blueviolet' }}
        >
      ...
      >
        <div className="project-image" style={{ cursor: 'pointer' }}>
          <img
            src="https://lh3.googleusercontent.com/proxy/YK0P7YgeFMP_pxQXVFIbwG3tWcI_H1z2wj9pCQUwy6RXjPzvCKbywuflxn2NrI8IydNGqsP95xNK4C1SniG1KRMqOQjAp2XkSshsNQ"
            alt="project"
            width="100px"
            height="100px"
          />
      ...
      <div className="extra content">
        <div className="ui three buttons">
          <Popup
            ...
            pinned
            trigger={
              <button className="ui green basic button" content="Button">
                Tasks
              </button>
            }
          />
