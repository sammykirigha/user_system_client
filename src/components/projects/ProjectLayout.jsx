...
import { getUsername, isTokenExpired } from '../helpers/Helpers';
...
const ProjectLayout = ({ component: Component, ...rest }) => {
    ...
    return (
        <Route {...rest} render={matchProps => isAuthenticated ? (
            <div>
                <ProjectsNavBar username={state?.user?.username} logout={logout} />
...
export default connect(null, { logout: logout })(ProjectLayout);
